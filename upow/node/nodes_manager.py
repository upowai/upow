...
class NodesManager:
    ...
    def init():
        ...
        NodesManager.nodes = NodesManager.db.get('nodes') or ['http://127.0.0.1:3006']
        NodesManager.last_messages = NodesManager.db.get('last_messages') or {'http://127.0.0.1:3006': timestamp()}
